...
import { StatusEnum, Story } from "../../backend/upload-stories.router";



export class State {

    webSocket$: Subject<any> = Backend.uploadStory.connectWs()
...
export class View implements VirtualDOM {
    ...
    selected$ = new ReplaySubject<Story>()
    ...
    if (node instanceof ModuleExplorer.FileNode
        ...
        return {
            ...
            children: [
                ...
                {
                    onclick: () => Backend.uploadStory.publish$(node.id).subscribe(),
